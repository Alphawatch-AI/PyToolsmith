            ...
            def func() -> str:
                ...
                try:
                    ...
                    if isinstance(tool_call_result, types.GeneratorType):
                        ...
                        invocation_output_lines.append(base_prefix)
                        try:
                            ...
                            if not stream_had_items:
                                invocation_output_lines.append(f"Stream (empty)")
                            ...
                            invocation_output_lines.append(
                                f"Stream Error: {str(e_stream_iter)}"
                            )
                    else:
                ...
                return ''.join(invocation_output_lines)
